...
class DateFormatter {
	public static void main(String[] args) {
		...
		DateFormat nfIndia = DateFormat.getDateInstance(DateFormat.DEFAULT,
				india);
		DateFormat nfAmerica = DateFormat.getDateInstance(DateFormat.DEFAULT,
				america);
		DateFormat nfGermany = DateFormat.getDateInstance(DateFormat.DEFAULT,
				germany);
