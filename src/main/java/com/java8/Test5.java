...
public class Test5 {
	public static void main(String args[]) {
		...
		listOfInts.add(43);listOfInts.add(5);listOfInts.add(1);listOfInts.add(868);listOfInts.add(7);listOfInts.add(15);listOfInts.add(15);listOfInts.add(55);
		...
		listOfInts.forEach(j -> System.out.print(j + " "));
	}
}
