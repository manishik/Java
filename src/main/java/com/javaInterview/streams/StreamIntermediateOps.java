...
public class StreamIntermediateOps {
    ...
    public static void main(String[] args) {
        ...
        // Output: Number List = [1, 1, 92, -2, -2, 46, 5, 5, 0, 7, 4, 4, -44, 55, 55, 8, -5, -77, -9, 10, 10, 12, 12]
        ...
        // Output: Even Number List = [92, -2, -2, 46, 0, 4, 4, -44, 8, 10, 10, 12, 12]

        // Reversing the list
        Collections.reverse(evenNumberList);
        System.out.println("Even Number List Reversed = " + evenNumberList);
        // Output: Even Number List Reversed = [12, 12, 10, 10, 8, -44, 4, 4, 0, 46, -2, -2, 92]
        ...
        // Output: Even Number List Squares = [144, 144, 100, 100, 64, 1936, 16, 16, 0, 2116, 4, 4, 8464]

        List<Integer> lengths = wordsList.stream().map(String::length).toList();
        System.out.println("Length of each word = " + lengths);
        // Output: Length of each word = [5, 6, 6, 5]
        ...
        // Output: Names of Animals = [Panda, Tiger, Elephant, Dog, Cat, Horse]
        ...
        // Output: Names of Animals whose age is more than 10 = [Panda, Elephant, Horse]

        List<String> greetings = wordsList.stream().map(name -> "Hello, " + name + "!").collect(Collectors.toList());
        System.out.println("Greetings = " + greetings);
        // Output: Greetings = [Hello, Apple!, Hello, banana!, Hello, cherry!, Hello, Apple!]

        System.out.println("Counting the number of occurances: ");
        // Output: Counting the number of occurances:
        ...
        for (char[] arr : charArrays) {
            ...
            // Output over the four iterations: [A, p, p, l, e]
            // [b, a, n, a, n, a]
            // [c, h, e, r, r, y]
            // [A, p, p, l, e]
        }
        ...
        // Output: stringNumbers = [1, 1, 92, -2, -2, 46, 5, 5, 0, 7, 4, 4, -44, 55, 55, 8, -5, -77, -9, 10, 10, 12, 12]
        ...
        // Output: firstCharsInWordsList = [A, b, c, A]
        ...
        // Output: doubledNumbers = [2, 2, 184, -4, -4, 92, 10, 10, 0, 14, 8, 8, -88, 110, 110, 16, -10, -154, -18, 20, 20, 24, 24]
        ...
        // Output: Even Number List Reversed & Squared = [8464, 4, 4, 2116, 0, 16, 16, 1936, 64, 100, 100, 144, 144]

        /*---------------------------------------------------------------------------------------*/
        // sorted (Sorts elements)
        System.out.println("Sorted Number List = " + numbersList.stream().sorted().collect(Collectors.toList()));
        // Output: Sorted Number List = [-77, -44, -9, -5, -2, -2, 0, 1, 1, 4, 4, 5, 5, 7, 8, 10, 10, 12, 12, 46, 55, 55, 92]
        ...
        // Output: Sorted Number List (Reversed) = [92, 55, 55, 46, 12, 12, 10, 10, 8, 7, 5, 5, 4, 4, 1, 1, 0, -2, -2, -5, -9, -44, -77]
        ...
        // Output: The Structure before flattening is : [[2, 3, 5, 7, 11, 13, 17, 19], [1, 3, 5], [2, 4, 6, 8]]
        ...
        // Output: The Structure after flattening is : [2, 3, 5, 7, 11, 13, 17, 19, 1, 3, 5, 2, 4, 6, 8]
        ...
        System.out.println("Phrases = " + phrases.stream().flatMap(phrase -> Stream.of(phrase.split("\\s+")))
                .distinct().toList());
        // Output: Phrases = [sporadic, perjury, confounded, skimming, incumbent, jailer]
        ...
        // Output: Integer Stream = [1, 2, 3, 4, 5]
