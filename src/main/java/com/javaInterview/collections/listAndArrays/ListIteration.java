...
public class ListIteration {
    public static void main(String[] a) {
        ...
        List<Integer> listOfOddNumberesSquares = listofInts.stream().filter(x -> x % 2 != 0).map(y -> y * y).collect(Collectors.toList());
        System.out.println("List of Odd Numbers Squared : " + listOfOddNumberesSquares);
    }
}
